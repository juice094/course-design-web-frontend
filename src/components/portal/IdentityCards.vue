<template>
  <div class="id-grid">
    ...
    <div class="id-card">
      ...
      <div class="id-body">
        <div class="id-row">
          <span class="id-key">院校</span><span class="id-val">甘肃农业大学</span>
        </div>
        <div class="id-row">
          <span class="id-key">专业</span><span class="id-val">计算机科学与技术</span>
        </div>
        <div class="id-row">
          <span class="id-key">年级</span><span class="id-val">2022 级 · 大三</span>
        </div>
        <div class="id-row">
          <span class="id-key">绩点</span><span class="id-val highlight">3.82 / 4.0</span>
        </div>
      </div>
      <div class="id-tags">
        <span class="tag student-tag">数据结构</span>
        <span class="tag student-tag">操作系统</span>
        <span class="tag student-tag">计算机网络</span>
      </div>
    </div>
    ...
    <div class="id-card">
      ...
      <div class="id-tags">
        <span class="tag gamer-tag">RPG</span>
        <span class="tag gamer-tag">FPS</span>
        <span class="tag gamer-tag">策略</span>
      </div>
    </div>
  </div>
</template>
